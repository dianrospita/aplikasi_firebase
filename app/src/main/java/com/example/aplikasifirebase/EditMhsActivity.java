...
public class EditMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum-firebase-80a9d-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("mhs").child(nim);
